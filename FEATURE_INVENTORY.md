...
| Frontend | `admin-app/src/components/PortalLayout.jsx`; `admin-app/src/pages/PortalHome.jsx`, `PortalEvents.jsx`, `PortalRegister.jsx`, `PortalMyRegistrations.jsx`, `PortalLogin.jsx`; `admin-app/src/api/portal.js`, `portalAuth.js`; `admin-app/src/utils/portalFormat.js`; routing in `admin-app/src/App.jsx` |
