...
const FEEDBACK_SCHEMAS = {
  ...
  beta_uat: {
    ...
    groups: [
      ...
      {
        key: "admin_audit_log",
        label: "Admin Audit Log Viewer",
        tasks: [
          { key: "audit_log_task_1", label: "Ease of finding the Audit Log" },
          { key: "audit_log_task_2", label: "Clarity of audit entries" },
          { key: "audit_log_task_3", label: "Ability to locate needed information" },
          { key: "audit_log_task_4", label: "Overall usability" },
        ],
      },
      {
        key: "communications_center_detailed",
        label: "Communications Center (Detailed)",
        tasks: [
          { key: "commcenter_task_1", label: "Creating a message" },
          { key: "commcenter_task_2", label: "Editing/deleting messages" },
          { key: "commcenter_task_3", label: "Message history" },
          { key: "commcenter_task_4", label: "Overall workflow" },
        ],
      },
      {
        ...
        tasks: [
          { key: "permissions_task_1", label: "Ease of locating users/roles" },
          { key: "permissions_task_2", label: "Understanding permissions" },
          { key: "permissions_task_3", label: "Overall usability" },
        ],
      },
      {
        key: "automation_management",
        label: "Automation Management",
        tasks: [
          { key: "automation_task_1", label: "Finding workflows" },
          { key: "automation_task_2", label: "Enable/disable workflow" },
          { key: "automation_task_3", label: "Manual execution" },
          { key: "automation_task_4", label: "Execution history" },
          { key: "automation_task_5", label: "Overall clarity" },
        ],
      },
      {
      ...
      },
      {
        ...
        tasks: [
          { key: "admin_overall_task_1", label: "Ease of navigation between administrative pages" },
          { key: "admin_overall_task_2", label: "Consistency of the interface" },
          { key: "admin_overall_task_3", label: "Confidence using the system without assistance" },
        ],
      },
    ],
    commentFields: [
      ...
      { key: "audit_log_comments", label: "Audit Log Viewer comments" },
