    ...
    <div className="p-4 space-y-6">
      ...
      {/* Volunteer Type Breakdown */}
        ...
        <div className="space-y-2">
          ...
          {widgetVisibility.participantCapacity ? <div className="bg-white rounded-xl shadow p-4 space-y-3">
        <p className="text-sm font-medium text-secondary">
          Participant Capacity
        </p>
        {participantCapacity ? (
          ...
          {widgetVisibility.checkInProgress ? <div className="bg-white rounded-xl shadow p-4 space-y-3">
        <p className="text-sm font-medium text-secondary">
          Check-In Progress
        </p>
